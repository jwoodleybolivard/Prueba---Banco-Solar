...
const errores = (error, res) => {
    ...
    const errorMessages = {
        ...
        '22P02': "El valor de emisor, monto y/o receptor deben ser de tipo integer .",
        ...
        'DATOS_INCOMPLETOS': "Todos los campos son obligatorios y deben contener un tipo de dato correcto.",
